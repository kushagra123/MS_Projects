    ...
    def on_data(self, data):
        try:
            ...
            if not decoded['text'].startswith('RT'):  # filters out retweets
                with open('../data/input/twitterdata_thailand.json', 'a', encoding='utf-8', newline='') as f:
                    f.write(data)
                return True
...
twitter_stream.filter(track=subtopic, languages=['en'], locations=[100,13,100.7,15])