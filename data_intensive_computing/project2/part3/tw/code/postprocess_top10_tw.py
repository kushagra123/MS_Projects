...
def top10(filename):
    ...
    file.close()
    count = 0
    dict_words=post_process_dict(dict_words, './data/twitterWords.txt')
    with open('./data/top10_twitter.txt', 'w', encoding='utf-8', newline='') as outfile:
...
def main():
    top10('../../../part2/mr_output/output_tw_wc')
